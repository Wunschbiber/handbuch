---
id: edit-wish
title: Wünsche bearbeiten und verwalten
slug: /wuensche-verwalten
...
Öffne in den Wunschdetails das Menü und wähle **Verschieben** oder **Kopieren**. Wähle anschließend die gewünschte **Wunschliste** und, falls vorhanden, eine **Gruppe** aus und bestätige die Aktion.

Diese Optionen sind nur verfügbar, wenn du bereits mehrere Wunschlisten oder Gruppen angelegt hast.

Gruppen kannst du direkt in einer Wunschliste anlegen. In der Anleitung [Wünsche in Gruppen organisieren und getrennt teilen](./organize-with-groups.md) erfährst du außerdem, wie du Wünsche direkt in einer Gruppe hinzufügst.

- Beim Verschieben wird der Wunsch aus seiner bisherigen Liste oder Gruppe entfernt und am neuen Ziel eingeordnet.
- Beim Kopieren bleibt der bisherige Wunsch bestehen und Wunschbiber legt am gewählten Ziel eine zusätzliche Kopie an.

## Einen Wunsch löschen

1. Öffne den Wunsch und anschließend das Menü oben rechts.
2. Wähle **Löschen**.
